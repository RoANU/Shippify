...
public class User_type extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef = database.getReferenceFromUrl("https://ship-33e41.firebaseio.com/activeDriver");
                ...
                switch (checkedId) {
                    ...
                    case R.id.rb1:
                       ...
                       /* myRef.child("User").child(personId).child("userType").setValue("user");
                        ...
                        Intent i = new Intent(User_type.this, MapsActivityCurrentPlace.class);
                        startActivity(i);
                        break;
        ...
        mGoogleSignInClient.signOut()
                .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Intent intent = new Intent(User_type.this, signIn.class);
